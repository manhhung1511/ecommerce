                ...
                <div className={cx("success_content")}>
                    <p  className={cx("success_content-logo")}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none">
                            <path d="M43 26L28.3333 40L21 33" stroke="#039855" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M32 56C45.2548 56 56 45.2548 56 32C56 18.7452 45.2548 8 32 8C18.7452 8 8 18.7452 8 32C8 45.2548 18.7452 56 32 56Z" stroke="#039855" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </p>
                    ...
                    <Link to="/">
                                <button className={cx("success_content-submit")}>
                                Tiếp tục mua sắm
                                </button>
                               </Link>
